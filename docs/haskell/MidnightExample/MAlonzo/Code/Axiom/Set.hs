...
data T_SpecProperty_48
  = C_SpecProperty'46'constructor_1773 (() ->
                                        (AgdaAny -> ()) ->
                                        () -> AgdaAny -> (AgdaAny -> AgdaAny) -> AgdaAny)
                                       (() -> (AgdaAny -> ()) -> AgdaAny -> AgdaAny)
...
d_sp'45''8728'_68 v0
  = case coe v0 of
      C_SpecProperty'46'constructor_1773 v2 v3 -> coe v2
...
d_sp'45''172'_70 v0
  = case coe v0 of
      C_SpecProperty'46'constructor_1773 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_Theory_82 a0 = ()
data T_Theory_82
  = C_Theory'46'constructor_6867 T_SpecProperty_48
                                 (() ->
                                  (AgdaAny -> ()) ->
...
d_sp_150 v0
  = case coe v0 of
      C_Theory'46'constructor_6867 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_specification_174 v0
  = case coe v0 of
      C_Theory'46'constructor_6867 v3 v4 v5 v6 v7 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_unions_184 v0
  = case coe v0 of
      C_Theory'46'constructor_6867 v3 v4 v5 v6 v7 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_replacement_196 v0
  = case coe v0 of
      C_Theory'46'constructor_6867 v3 v4 v5 v6 v7 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_listing_204 v0
  = case coe v0 of
      C_Theory'46'constructor_6867 v3 v4 v5 v6 v7 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
                                 ...
                                 = coe
                                     ...
                                     (coe
                                        ...
                                        (coe
                                           MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                                           (coe
                                              MAlonzo.Code.Function.Bundles.d_from_940 (coe v5 v6)
                                              v7)))
                                     (MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                                        (coe
                                           MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
...
data T_Theory'7584'_728
  = C_Theory'7584''46'constructor_99881 T_Theory_82
                                        (() -> AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14)
...
d_theory_860 v0
  = case coe v0 of
      C_Theory'7584''46'constructor_99881 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_finiteness_988 v0
  = case coe v0 of
      C_Theory'7584''46'constructor_99881 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_Theory'8305'_1000
  = C_Theory'8305''46'constructor_103093 T_Theory_82
                                         MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Axiom.Set._._Preservesˢ_
...
d_theory_1134 v0
  = case coe v0 of
      C_Theory'8305''46'constructor_103093 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_infinity_1264 v0
  = case coe v0 of
      C_Theory'8305''46'constructor_103093 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Axiom.Set.Theoryᵈ
d_Theory'7496'_1266 = ()
data T_Theory'7496'_1266
  = C_Theory'7496''46'constructor_106671 T_Theory_82
                                         (() ->
                                          MAlonzo.Code.Interface.DecEq.T_DecEq_14 ->
                                          AgdaAny -> AgdaAny)
                                         (() ->
...
d_th_1414 v0
  = case coe v0 of
      C_Theory'7496''46'constructor_106671 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_'8712''45'sp_1540 v0
  = case coe v0 of
      C_Theory'7496''46'constructor_106671 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Axiom.Set.Theoryᵈ._∈?_
d__'8712''63'__1542 ::
  T_Theory'7496'_1266 ->
...
d__'8712''63'__1542 v0
  = case coe v0 of
      C_Theory'7496''46'constructor_106671 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_all'63'_1550 v0
  = case coe v0 of
      C_Theory'7496''46'constructor_106671 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_any'63'_1558 v0
  = case coe v0 of
      C_Theory'7496''46'constructor_106671 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    MAlonzo.Code.Function.Bundles.d_to_938
                                    (coe
                                       du_'8712''45'mapPartial_568 (coe d_th_1414 (coe v0)) (coe v2)
                                       (coe
                                          MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 (coe v3)
                                          (coe v8))
